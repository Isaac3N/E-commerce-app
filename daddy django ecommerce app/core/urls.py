...
from .views import CheckoutView, HomeView, ItemDetailView, OrderSummaryView, add_to_cart, remove_from_cart, remove_single_item_from_cart, PaymentView, AddCouponView, RequestRefundView
...
urlpatterns = [
    ...
    path("remove-item-from-cart/<str:slug>/",
