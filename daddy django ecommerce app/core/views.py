            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address1, shipping_country, shipping_zip]):
                        ...
                        messages.info(
                            self.request, "Please fill out the required fields.")

                payment_option = form.cleaned_data.get('payment_option')
                # TODO: add or redirect to the selected payment option
                if payment_option == "S":
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        # add a message saying the user doeesnt have an order
